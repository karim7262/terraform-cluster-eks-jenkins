...
#   }
# }
resource "nirmata_cluster_type_eks" "eks-cluster-type-3" {
  name                      = "tf-eks-cluster-type-3"
  version                   = "1.19"
...
resource "nirmata_cluster" "eks-cluster-3" {
  name                 = "eks-cluster-3"
  cluster_type         = nirmata_cluster_type_eks.eks-cluster-type-3.name
  node_count           = 1
}